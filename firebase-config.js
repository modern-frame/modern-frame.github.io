...
/* PromptPay รับเงิน — เบอร์มือถือ/เลขบัตรปชช./e-wallet ID ของร้าน
   เว้นว่าง = ปิดฟีเจอร์ | ใส่แล้วลูกค้าจะเห็น QR พร้อมยอดอัตโนมัติหลังสั่ง/ตอนเก็บเงิน
   ค่าปัจจุบัน = e-wallet/biller ID ถอดจาก QR PromptPay ของร้าน (บัญชี ...7790 วชิรวิทย์) */
window.PROMPTPAY_ID = "004999022408412";
