...
/* PromptPay รับเงิน — ใส่เบอร์มือถือพร้อมเพย์ หรือเลขบัตรปชช./Tax ID ของร้าน
   เว้นว่าง = ปิดฟีเจอร์ (ไม่โชว์ QR จ่ายเงิน) | ใส่แล้วลูกค้าจะเห็น QR พร้อมยอดหลังสั่ง
